...
storage_ip_address="${1:-10.10.0.4}"
truenas_ip_address="${2:-10.10.0.2}"
storage_mtu="${3:-9000}"
k3s_version="${4:-v1.26.2+k3s1}"
k9s_version="${5:-v0.27.3}"
helm_version="${6:-v3.11.2}"
democratic_csi_chart_version="${7:-0.13.5}"
democratic_csi_tag="${8:-v1.8.1}"
gitea_chart_version="${9:-7.0.4}"
gitea_version="${10:-1.19.0}"
fqdn="$(hostname --fqdn)"
k3s_fqdn="s.$(hostname --domain)"
k3s_url="https://$k3s_fqdn:6443"
ip_address="$storage_ip_address"
